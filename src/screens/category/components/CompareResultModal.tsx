...
const CompareResultItem = ({ product }: CompareResultItemProps) => {
  ...
  return (
    <View style={styles.resultItem}>
      ...
      <TouchableOpacity style={styles.expandBtn} onPress={handleExpandToggle} activeOpacity={0.7}>
      ...
      {!contactOpen ? (
        <TouchableOpacity style={styles.contactBtn} onPress={handleContactOpen} activeOpacity={0.8}>
...
export const CompareResultModal = ({ visible, products, onClose }: CompareResultModalProps) => {
