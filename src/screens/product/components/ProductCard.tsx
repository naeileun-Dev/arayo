...
export const ProductCard = ({ width: cardWidth, height: cardHeight, liked, onLike }: ProductCardProps) => (
  <View style={{ width: cardWidth, marginRight: 12 }}>
    <View style={cardStyles.imageContainer(cardWidth, cardHeight)}>
...
const cardStyles = {
  imageContainer: (width: number, height: number) => ({
    width,
    height,
    borderRadius: 8,
    marginBottom: 8,
